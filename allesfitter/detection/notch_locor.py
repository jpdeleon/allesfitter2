"""Notch and LOCoR detrending, for use as alternative ``transit-search``
flatten methods.

Ported from the ``quicklook`` project's ``quicklook.notch_locor`` module
(same author). Algorithm design follows the Notch filter and Locally
Optimized Combination of Rotations (LOCoR) methods described in Rizzuto et
al. 2017 (https://arxiv.org/abs/1709.09670) and implemented in
