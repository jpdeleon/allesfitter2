...
from allesfitter.time_series import mask_regions, sigma_clip, slide_clip
...
results_all, fig_all = tls_search(
    time, flux_flat, flux_err, plot=True, period_min=1, period_max=20, **kwargs
)
