"""Tests for allesfitter.detection.notch_locor (Notch filter and LOCoR
detrending), ported from the quicklook project's test suite."""
...
from allesfitter.detection.notch_locor import _label_cycles, locor_flatten, notch_flatten
